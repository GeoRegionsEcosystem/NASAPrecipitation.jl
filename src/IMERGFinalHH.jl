...
function download(
	...
	@info "$(now()) - NASAPrecipitation.jl - Preallocating temporary arrays for extraction of Final IMERG data for the $(geo.name) GeoRegion from the original gridded dataset"
